...
# 1) install notebooks
eval "az synapse notebook import --workspace-name $synapse_workspace --name Graph_example --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Graph_example.ipynb --only-show-errors"
eval "az synapse notebook import --workspace-name $synapse_workspace --name Graph_OEA_Connector --spark-pool-name spark3p2sm --file @$this_file_path/notebook/Graph_OEA_Connector.ipynb --only-show-errors"
